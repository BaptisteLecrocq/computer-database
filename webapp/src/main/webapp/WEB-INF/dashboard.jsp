...
<head>
	<meta charset="UTF-8">
	<!-- Bootstrap -->
	<link href="../../webapp/static/css/bootstrap.min.css" rel="stylesheet" media="screen">
	<link href="../../webapp/static/css/font-awesome.css" rel="stylesheet" media="screen">
	<link href="../../webapp/static/css/main.css" rel="stylesheet" media="screen">
	<title>
...
<header class="navbar navbar-inverse navbar-fixed-top flex">
        <div class="container">
            <a class="navbar-brand" href="app"> Application - Computer Database </a>
...
<script src="../../webapp/static/js/dashboard.js"></script>
